...
import ScreenImg1 from "../../assets/image/about-1.jpg";
import ScreenImg2 from "../../assets/image/about-2.jpg";
                ...
                <div className="row g-5">
                    <div className="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                        <div className="about-img">
                            <img className="img-fluid" src={ScreenImg1} alt="" />
                            <img className="img-fluid" src={ScreenImg2} alt="" />
                        </div>
                    </div>
